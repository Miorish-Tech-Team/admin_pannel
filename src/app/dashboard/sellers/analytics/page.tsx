...
import { FaChartLine, FaHardHat } from "react-icons/fa";
    ...
    <div>
      ...
      <div className="mb-6">
        ...
        <p className="mt-1 font-poppins text-sm" style={{ color: colors.darkgray }}>
          View seller performance metrics and statistics
        </p>
      </div>
      ...
      >
        ...
        <p className="font-poppins text-sm max-w-md mx-auto" style={{ color: colors.darkgray }}>
          This feature is under development. You'll be able to view detailed analytics and performance metrics for all sellers.
        </p>
      </div>
    </div>
  );
